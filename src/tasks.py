...
# Here we are defining tasks without using the YAML configuration

class MeetingPrepTasks():

    '''
    Research Task:-
    1. Description: research {participants} & {meeting context}
    2. Output: report with findings
    3. agent: Researcher
    4. async: True
    '''
    ...
    def research_task(self, agent, meeting_participants, meeting_context):
        return Task(
            description=dedent(f"""\
                ...
                new, achievements, professional background, and any relevant
                business activities.
            ...
            agent=agent,
            async_execution=True #Starts without waiting as it is not dependant
        )
